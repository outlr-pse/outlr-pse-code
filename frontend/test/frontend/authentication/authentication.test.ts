...
describe('Authentication',  function () {
    ...
    test.skip('registering and then logging in', async () => {
    ...
    test.skip("registering with invalid username", async () => {
        const username = "H1"
    ...
    test.skip("registering with invalid password", async () => {
    ...
    test.skip("registering with username already taken", async () => {
        const username = "SCH3LOM0"
